...
// ==================== ICONS ====================
const StarIcon = ({ filled = false, hovered = false }: { filled?: boolean; hovered?: boolean }) => (
  <svg 
...
const StarRating: React.FC<{
  ...
  return (
    <div className="text-center">
      ...
      <div className={`text-lg font-medium ${ratingLabels[hoverRating || rating]?.color}`}>
        <span className="text-2xl mr-2">{ratingLabels[hoverRating || rating]?.emoji}</span>
        ...
        <div className="max-w-md w-full text-center">
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <p className="text-slate-600 mb-6">
              Thank you for your feedback! Your review helps other students make better decisions.
            </p>
            <Link
              to="/student"
        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            ...
            <p className="text-slate-600 text-center mb-6">
              Are you sure you want to leave your current hostel? This action cannot be undone.
            </p>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <svg 
                        key={star}
                        className={`w-5 h-5 ${star <= rating ? 'text-amber-400 fill-amber-400' : 'text-slate-300'}`} 
                        viewBox="0 0 20 20"
                      >
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 px-6 py-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-white mb-2">Leave Your Hostel</h1>
            <p className="text-slate-400 max-w-md mx-auto">
              Before you go, please share your experience to help future students
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 mt-0.5">
                  Leaving will end your current booking. Make sure to collect all your belongings 
                  and settle any pending dues with the hostel manager.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            <div>
              ...
              {/* Prompts */}
              <div className="mb-4">
                <p className="text-xs text-slate-500 mb-2">Consider mentioning:</p>
                <div className="flex flex-wrap gap-2">
                  {reviewPrompts.map((prompt, idx) => (
                    <button
                      key={idx}
                      type="button"
                      onClick={() => setReview(prev => prev + (prev ? ' ' : '') + prompt)}
        ...
        <div className="mt-6 p-4 bg-slate-100 rounded-xl">
          <p className="text-sm text-slate-600 text-center">
            ...
            <a href="mailto:support@hostelhub.pk" className="text-slate-900 font-medium hover:underline">
